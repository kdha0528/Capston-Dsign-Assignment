                ...
                <section>
                  <div class="inner">
                    <div class="join_contents">
                      <form action="edit_myinfo_proc.php" method="POST" name="form">
                      ...
                      <secton class="step_cont">
                       ...
                       <div class="btn_layout mt40" style="display:flex; flex-direction:row; justify-content: center;">                         
                         <button type="submit" class="full_btn btn-submit" style="margin-right:10px;">회원정보 수정</button>
                         <a href="remove_account.php" class="btn33" style="background-color:red; margin-left:10px;">회원탈퇴</a>
                       </div>
                      </secton>
                    </div>
                  </div>  
